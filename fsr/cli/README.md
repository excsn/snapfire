...
| Mount an island written for another framework | nothing to set: the extension picks the adapter, `@snapfire/fsr-client/vue` for `.vue`; one no adapter mounts fails the build |
